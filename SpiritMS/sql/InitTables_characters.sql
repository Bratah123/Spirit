...
insert into `users` (`name`, `password`, `accounttype`, `chatunblockdate`, `pic`, `characterslots`) values ('admin2', 'admin', '4', '0', '111111', '40');
insert into `users` (`name`, `password`, `accounttype`, `chatunblockdate`, `pic`, `characterslots`) values ('brandon', 'admin', '4', '0', '111111', '40');